		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(['home/goods','id'=>$model->id])?>"><img src="<?=$model->logo?>" alt="" /></a></dt>
...
<?php endforeach;?>
			...
			<!-- 商品列表 end-->
            <?= \yii\widgets\LinkPager::widget(['pagination' => $pageObj,'options' => ['class'=>'page mt20']])?>
			<!-- 分页信息 start -->
