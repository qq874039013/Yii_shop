...
<body>
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <?php  require  \Yii::getAlias('@app/views/common/menu.php')?>
        <!--  商品分类部分 end-->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$goodsGallerys?$goodsGallerys[0]->img:$models->logo;?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$goodsGallerys?$goodsGallerys[0]->img:$models->logo;?>" alt="" width="350"  height="350"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
                                <?php foreach ($goodsGallerys as $k=>$v):?>
								<li class="<?=$k==0?'cur':""?>">
									<a class="" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$v->img?>',largeimage: '<?=$v->img?>'}"><img src="<?=$v->img?>"></a>
								</li>
                                <?php endforeach;?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>定价：</span><em>￥<?=$models->market_price?>.00</em></li>
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$models->shop_price?>.00</strong> <a href="">(降价通知)</a></li>
						<li><span>上架时间：</span><?=$models->inputtime?></li>
							...
							<li>
								<dl>
									...
									<dd>
										...
										<input type="hidden" name="id" value="<?=$models->id?>" class="amount"/>
